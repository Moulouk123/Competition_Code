...
<div class="filter-buttons">
        ...
        @auth
        <a type ="button" class="button button-secondary" href="{{ route('FilterMyQuestions', ['id' => Auth::user()->id]) }}">My Questions</a>
   @endauth
            ...
            <div class="col-md-3">
                <div class="card">
                    <div class="card-title">
                      <a href="{{ route('user.profile', ['user_id' => $question->user_id]) }}"> <img src="{{ asset('storage/' .\App\Models\User::find($question->user_id)->photo ) }}" alt="User Image"></a>
