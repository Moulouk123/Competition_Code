...
@endif
    ...
    <div class="form-container">
        <h2 id="form-title" id="missionForm">Add Set UP</h2>
        ...
        <form id="missionForm" action="{{ url('/addMission') }}" method="post">
            ...
            <button id="submitButton" type="submit" id="submitButton">Add Mission</button>
        </form>
    </div>
...
<form class="update-form" action="{{ url('/updateMission/' . $mission->id) }}" method="post">
    ...
    <button class="btn btn-outline-success btn-fw update-button" type="button" data-mission="{{ $set->mission }}" data-mission-id="{{ $mission->id }}">UPDATE</button>
</form>
