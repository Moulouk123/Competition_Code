...
@endif
    ...
    <div class="form-container">
        <h2 id="form-title" id="valueForm">Add Value</h2>

        <form id="valueForm" action="{{ url('/addValue') }}" method="post">
            @csrf
            ...
            <button style="background-color: #9747FF" type="submit" id="submitButton">Add Value</button>
        </form>
    </div>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form  action="{{ url('/deleteValue/' . $value->id) }}" method="post">
                                    @csrf
                                    @method('DELETE')
                            ...
                            <td>
                                <!-- Update form -->
                                <form class="update-form" action="{{ url('/updateValue/' . $value->id) }}" method="post">
                                    @csrf
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        updateButtons.forEach(function (button) {
            button.addEventListener('click', function () {
                ...
                valueForm.action = '{{ url('/updateValue') }}/' + valueId;
                submitButton.innerText = 'Update Value';

                // Change form title
                formTitle.innerText = 'Update Value';
            });
        });
    });
